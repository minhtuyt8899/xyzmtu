...
class Main:
 ...
 __       __  ______  __    __  __    __  ________  __    __  __      __  ________ 
|  \     /  \|      \|  \  |  \|  \  |  \|        \|  \  |  \|  \    /  \|        \
| $$\   /  $$ \$$$$$$| $$\ | $$| $$  | $$ \$$$$$$$$| $$  | $$ \$$\  /  $$ \$$$$$$$$
| $$$\ /  $$$  | $$  | $$$\| $$| $$__| $$   | $$   | $$  | $$  \$$\/  $$    | $$   
| $$$$\  $$$$  | $$  | $$$$\ $$| $$    $$   | $$   | $$  | $$   \$$  $$     | $$   
...
C_Bo-----------------------------------------------------------C_W""")
	...
	def _add_commands(self):
		...
		event.help("upgrade", "Upgrade XyZmtu.")
		...
		event.help("ddos", "Connect to a XyZmtu server.")
		event.help_comment("\nModules:")
	...
	def upgrade():
		try:
			...
			print("Cound not upgrade XyZmtu. (Make sure to use sudo)")
